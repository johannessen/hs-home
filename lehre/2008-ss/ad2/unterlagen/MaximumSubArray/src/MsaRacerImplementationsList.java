/* $Id: MsaRacerImplementationsList.java,v 1.1 2008-06-18 00:29:55 aj3 Exp $
 * by Arne Johannessen
...
//		this.implementations.add(solverImplementation);
	...
	public void startRace (int arrayLength) {
		this.stopRace();
		int[] array = RandomisedArrayFactory.createRandomArray((arrayLength >= 0) ? arrayLength : 2500);
